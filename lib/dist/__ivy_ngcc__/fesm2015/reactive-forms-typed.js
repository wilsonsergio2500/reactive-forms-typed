...
FormControlOnErrorItemDirective.ɵfac = function FormControlOnErrorItemDirective_Factory(t) { return new (t || FormControlOnErrorItemDirective)(ɵngcc0.ɵɵdirectiveInject(FormGroupDirective), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
FormControlOnErrorItemDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: FormControlOnErrorItemDirective, selectors: [["", "formControlOnErrorItem", ""]], hostVars: 1, hostBindings: function FormControlOnErrorItemDirective_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵhostProperty("hidden", ctx.hidden);
    } }, inputs: { errors: "errors", showOnFormTouched: "showOnFormTouched", formControlItem: ["formControlOnErrorItem", "formControlItem"] } });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FormControlOnErrorItemDirective, [{
        type: Directive,
        args: [{
...
FormTypeBuilder.ɵfac = function FormTypeBuilder_Factory(t) { return new (t || FormTypeBuilder)(); };
FormTypeBuilder.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: FormTypeBuilder, factory: FormTypeBuilder.ɵfac });
FormTypeBuilder.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FormTypeBuilder, [{
        type: Injectable
    }], function () { return []; }, null); })();

class ReactiveFormsTyped {
}
ReactiveFormsTyped.ɵfac = function ReactiveFormsTyped_Factory(t) { return new (t || ReactiveFormsTyped)(); };
ReactiveFormsTyped.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: ReactiveFormsTyped });
ReactiveFormsTyped.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [FormTypeBuilder], imports: [[
            CommonModule,
            FormsModule,
            ReactiveFormsModule
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ReactiveFormsTyped, { declarations: function () { return [FormControlOnErrorItemDirective]; }, imports: function () { return [CommonModule,
        FormsModule,
        ReactiveFormsModule]; }, exports: function () { return [FormControlOnErrorItemDirective]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ReactiveFormsTyped, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule,
...
export { FormControlOnErrorItemDirective, FormTypeBuilder, ReactiveFormsTyped };
